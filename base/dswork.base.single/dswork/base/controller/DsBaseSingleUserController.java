...
import dswork.base.service.DsBaseSingleUserService;
...
{
	@Autowired
	private DsBaseSingleUserService service;
	...
	public String getOrgTree()
	{
		...
		put("po", po);
		return "/ds/base/single/user/getOrgTree.jsp";
	}
	...
	public String addUser1()
	{
		...
		put("typeList", list);
		return "/ds/base/single/user/addUser.jsp";
	}
	...
	public String getUser()
	{
		...
		put("typeList", list);
		return "/ds/base/single/user/getUser.jsp";
	}
	...
	public String getUserById()
	{
		...
		put("po", po);
		return "/ds/base/single/user/getUserById.jsp";
	}
