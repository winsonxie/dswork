...
public class DsFlow
{
	...
	private List<DsFlowTask> taskList = null;
	...
	public List<DsFlowTask> getTaskList()
	{
		if (taskList == null)
		{
			return new ArrayList<DsFlowTask>();
		}
		return taskList;
	}

	public void setTaskList(List<DsFlowTask> taskList)
	{
