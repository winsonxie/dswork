...
CREATE TABLE DS_BASE_UNIT (
  ...
  TYPE                  BIGINT(16)    COMMENT '标记，值相同的为同一个UNIT',
...
CREATE TABLE DS_BASE_USER_BIND (
  ...
  BINDID                BIGINT(16)    COMMENT '所属来源应用ID',
  USERID                BIGINT(16)    COMMENT '主用户ID',
...
(
  ...
  SYSTEMID             BIGINT(16)    COMMENT '所属系统ID',
  NAME                 VARCHAR(30)   COMMENT '名称',
...
(
  ID                   BIGINT(16)    COMMENT '主键ID' NOT NULL,
  SYSTEMID             BIGINT(16)    COMMENT '系统ID',
  ROLEID               BIGINT(16)    COMMENT '角色ID',
  FUNCID               BIGINT(16)    COMMENT '功能ID',
  PRIMARY KEY (ID),
