...
import dswork.base.dao.DsBaseDaoCommonIDict;
import dswork.base.model.IDict;
import dswork.spring.BeanFactory;

public class DsBaseFactoryDict
{
	private static DsBaseDaoCommonIDict dao;
	private DsBaseFactoryDict()
	{
		if(dao == null)
		{
			dao = (DsBaseDaoCommonIDict) BeanFactory.getBean("DsBaseDaoCommonIDict");
		}
	}
	
	private static final DsBaseFactoryDict instace = new DsBaseFactoryDict();
	
	public static DsBaseFactoryDict getInstance()
	{
		return instace;
	}
