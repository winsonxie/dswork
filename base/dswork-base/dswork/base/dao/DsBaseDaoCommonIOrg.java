...
public class DsBaseDaoCommonIOrg extends MyBatisDao
{
	...
	{
		System.out.println("======== DsBaseDaoCommonIOrg call setSqlSessionTemplateCommon ========");
		hasCommon = true;
	...
	{
		return DsBaseDaoCommonIOrg.class;
	}
