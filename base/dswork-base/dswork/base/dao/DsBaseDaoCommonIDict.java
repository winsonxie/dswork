...
public class DsBaseDaoCommonIDict extends MyBatisDao
{
	...
	{
		System.out.println("======== DsBaseDaoCommonIDict call setSqlSessionTemplateCommon ========");
		hasCommon = true;
	...
	{
		return DsBaseDaoCommonIDict.class;
	}
