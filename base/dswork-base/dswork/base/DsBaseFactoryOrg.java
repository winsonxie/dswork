...
import dswork.base.dao.DsBaseDaoCommonIOrg;
import dswork.base.model.IOrg;
import dswork.base.model.IOrgTree;
import dswork.spring.BeanFactory;

public class DsBaseFactoryOrg
{
	private static DsBaseDaoCommonIOrg dao;

	private DsBaseFactoryOrg()
	{
		if(dao == null)
		{
			dao = (DsBaseDaoCommonIOrg) BeanFactory.getBean("DsBaseDaoCommonIOrg");
		}
	}
	private static final DsBaseFactoryOrg instace = new DsBaseFactoryOrg();

	public static DsBaseFactoryOrg getInstance()
	{
		return instace;
	}
