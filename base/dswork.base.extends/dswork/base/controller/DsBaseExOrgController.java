...
import dswork.base.service.DsBaseExOrgService;
import dswork.core.util.CollectionUtil;

@Controller
@RequestMapping("/ds/base/ex/org")
public class DsBaseExOrgController extends BaseController
{
	@Autowired
	private DsBaseExOrgService service;
	...
	public String addOrg1()
	{
		...
		put("parent", parent);
		put("pid", pid);
		return "/ds/base/ex/org/addOrg.jsp";
	}
	...
	public String updOrg1()
	{
		...
		put("po", po);
		put("parent", parent);
		return "/ds/base/ex/org/updOrg.jsp";
	}
	...
	public String updOrgSeq1()
	{
		...
		put("list", list);
		return "/ds/base/ex/org/updOrgSeq.jsp";
	}
	...
	public String updOrgMove1()
	{
		...
		put("rootid", rootid);
		return "/ds/base/ex/org/updOrgMove.jsp";
	}
	...
	public String getOrgTree()
	{
		...
		put("po", po);
		return "/ds/base/ex/org/getOrgTree.jsp";
	}
	...
	public String getOrg()
	{
		...
		put("rootid", rootid);
		put("pid", pid);
		return "/ds/base/ex/org/getOrg.jsp";
	}
	...
	public String getOrgById()
	{
		...
		DsBaseOrg po = service.get(id);
		put("po", po);
		return "/ds/base/ex/org/getOrgById.jsp";
	}
