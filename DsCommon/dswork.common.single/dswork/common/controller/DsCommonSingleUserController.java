...
import dswork.common.service.DsCommonSingleUserService;
...
@Controller
@RequestMapping("/ds/common/single/user")
public class DsCommonSingleUserController extends BaseController
{
	@Autowired
	private DsCommonSingleUserService service;
	...
	public String getOrgTree()
	{
		...
		put("po", po);
		return "/ds/common/single/user/getOrgTree.jsp";
	}
	...
	public String addUser1()
	{
		...
		put("typeList", list);
		return "/ds/common/single/user/addUser.jsp";
	}
	...
	public String updUser1()
	{
		...
		return "/ds/common/single/user/updUser.jsp";
	}
	...
	public String updUserOrg1()
	{
		...
		if(id > 0 || id == -1)
		{
			...
			put("po", po);
			put("page", req().getInt("page", 1));
			return "/ds/common/single/user/updUserOrg.jsp";
		}
		return null;
	}
	...
	public String updUserPassword1()
	{
		...
		if(id > 0)
		{
			...
			put("po", po);
			put("page", req().getInt("page", 1));
			return "/ds/common/single/user/updUserPassword.jsp";
		}
		return null;
	}
	...
	public String getUser()
	{
		...
		put("typeList", list);
		return "/ds/common/single/user/getUser.jsp";
	}
	...
	public String getUserById()
	{
		...
		put("po", po);
		return "/ds/common/single/user/getUserById.jsp";
	}
