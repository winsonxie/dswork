	...
	<div class="box"><div class="vbox">
		<fieldset class="fieldset">
			<legend id="regmsg" align="center" class="legend">其他方式注册<b style="color:#ff0000;">${type=='2'?'企业':'个人'}</b>用户</legend>
				...
				<a href="/websso/bind/login.jsp?bind=alipay&serviceURL=${serviceURL}" class="icon_alipay"></a>
				<a href="/websso/bind/login.jsp?bind=wechat&serviceURL=${serviceURL}" class="icon_wechat"></a>
		</fieldset>
	</div></div>
  </div>
