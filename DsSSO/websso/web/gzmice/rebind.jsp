...
%><!DOCTYPE html><html>
<c:if test="${msg==''}"><%
String serviceURL = "/websso/gzmice/rebindAction.jsp?type=" + type + "&service=" + java.net.URLEncoder.encode(java.net.URLEncoder.encode(service, "UTF-8"), "UTF-8");
String url = "/websso/bind/login.jsp?type=" + type + "&serviceURL=" + java.net.URLEncoder.encode(serviceURL, "UTF-8");
