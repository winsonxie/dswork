...
public class AuthGlobalSystem
{
	...
	public static void initAppConfig(String apiURL, String systemAlias, String systemPassword)
	{
		AuthGlobalSystem.apiURL = apiURL;
		AuthGlobalSystem.ssoName = ssoName;
		AuthGlobalSystem.ssoPassword = ssoPassword;
	}
